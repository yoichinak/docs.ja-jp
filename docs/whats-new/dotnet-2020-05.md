...
- [Ubuntu 20.04 パッケージマネージャー-.Net Core のインストール](../core/install/linux-package-manager-ubuntu-2004.md)-ubuntu 20.04 のインストールに関する記事
...
- [robvet](https://github.com/robvet) -渡 Vettor (5)
...
- [shon誤 ic](https://github.com/shonmisic) -nenad 誤 ic (2)
