...
- [Ubuntu 19.10 パッケージマネージャー-.Net Core のインストール](../core/install/linux-package-manager-ubuntu-1910.md)-ubuntu 19.10 の追加
...
- [global. json の概要](../core/tools/global-json.md)-3.0 の global. json を更新する
...
- [ \< 概要> (C# プログラミングガイド)](../csharp/programming-guide/xmldoc/summary.md) -XML ドキュメントコメントの更新

## <a name="net-framework"></a>.NET Framework

### <a name="updated-articles"></a>更新された記事

- [ランタイムディレクティブ (system.xml) 構成ファイルリファレンス](../framework/net-native/runtime-directives-rd-xml-configuration-file-reference.md)-.xml ドキュメントの書式設定を修正します。
...
- [Newtonsoft. json から system.string に移行する方法](../standard/serialization/system-text-json-migrate-from-newtonsoft-how-to.md)-新しい記事-新しい記事-新しい記事-Newtonsoft. json からの移行

### <a name="updated-articles"></a>更新された記事

- [バイナリシリアル化](../standard/serialization/binary-serialization.md)-バイナリシリアル化の機能強化
- [.Net で JSON のシリアル化と逆シリアル化 (マーシャリングとマーシャリング解除) を行う方法 (](../standard/serialization/system-text-json-how-to.md)新しい記事-新記事-Newtonsoft. JSON からの移行)
