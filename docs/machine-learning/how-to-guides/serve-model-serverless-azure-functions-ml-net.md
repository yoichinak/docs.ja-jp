...
お疲れさまでした。 Azure 関数を使用したインターネット経由での予測の実行に対して、モデルを正常に提供できました。

## <a name="next-steps"></a>次の手順

- [Azure へのデプロイ](/azure/azure-functions/functions-develop-vs#publish-to-azure)
