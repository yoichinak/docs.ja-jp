...
### [サーバーレス アプリ: アーキテクチャ、パターン、および Azure の実装](standard/serverless-architecture/)
## [オープン ソース ライブラリのガイダンス](standard/library-guidance/)
...
### [Memory<T> と Span<T> の使用ガイドライン](standard/memory-and-spans/memory-t-usage-guidelines.md)
## [ネイティブ相互運用性](standard/native-interop/index.md)
### [P/Invoke](standard/native-interop/pinvoke.md)
### [型のマーシャリング](standard/native-interop/type-marshalling.md)
### [構造体のマーシャリングのカスタマイズ](standard/native-interop/customize-struct-marshalling.md)
### [パラメーターのマーシャリングのカスタマイズ](standard/native-interop/customize-parameter-marshalling.md)
### [相互運用のガイダンス](standard/native-interop/best-practices.md)
### [文字セットとマーシャリング](standard/native-interop/charset.md)
...
### [Visual Studio 2017 を使用して C# または Visual Basic .NET Core の Hello World アプリケーションをデバッグする](core/tutorials/debugging-with-visual-studio.md)
### [Visual Studio 2017 での Hello World アプリケーションの発行](core/tutorials/publishing-with-visual-studio.md)
### [Visual Studio 2017 での C# と .NET Core を使用した .NET Standard ライブラリの構築](core/tutorials/library-with-visual-studio.md)
### [Visual Studio 2017 での Visual Basic と .NET Core を使用した .NET Standard ライブラリの構築](core/tutorials/vb-library-with-visual-studio.md)
### [Visual Studio 2017 での .NET Core を使用した .NET Standard ライブラリのテスト](core/tutorials/testing-library-with-visual-studio.md)
### [Visual Studio 2017 での .NET Standard ライブラリの使用](core/tutorials/consuming-library-with-visual-studio.md)
...
### [.NET Core 3.0 の新機能](core/whats-new/dotnet-core-3-0.md)
### [.NET Core 2.2 の新機能](core/whats-new/dotnet-core-2-2.md)
...
### [project.json からの移行](core/migration/index.md)
...
### [NET Core アプリのコンテナー化](core/docker/docker-basics-dotnet-core.md)
### [Docker の基本イメージを操作する](core/docker/building-net-docker-images.md)
...
#### [グローバル ツールの作成](core/tools/global-tools-how-to-create.md)
...
### [タブ補完を有効にする](core/tools/enable-tab-autocomplete.md)
...
### [C# の概要](csharp/tutorials/intro-to-csharp/index.md)
#### [Hello World](csharp/tutorials/intro-to-csharp/hello-world.yml)
#### [C# における数値](csharp/tutorials/intro-to-csharp/numbers-in-csharp.yml)
#### [分岐とループ](csharp/tutorials/intro-to-csharp/branches-and-loops.yml)
#### [文字列補間](csharp/tutorials/intro-to-csharp/interpolated-strings.yml)
#### [リスト コレクション](csharp/tutorials/intro-to-csharp/list-collection.yml)
#### [ローカル環境で作業する](csharp/tutorials/intro-to-csharp/local-environment.md)
##### [C# における数値](csharp/tutorials/intro-to-csharp/numbers-in-csharp-local.md)
##### [分岐とループ](csharp/tutorials/intro-to-csharp/branches-and-loops-local.md)
...
### [Null 許容参照型へのアプリをアップグレードする](csharp/tutorials/upgrade-to-nullable-references.md)
### [非同期ストリームの生成と使用](csharp/tutorials/generate-consume-asynchronous-stream.md)
### [パターン マッチングを使用してデータ機能を拡張する](csharp/tutorials/pattern-matching.md)
...
### [文字列補間](csharp/tutorials/string-interpolation.md)
### [属性の使用](csharp/tutorials/attributes.md)
...
### [Null 許容参照型](csharp/nullable-references.md)
...
### [`String.Split` を使用して文字列を解析する](csharp/how-to/parse-strings-using-split.md)
### [文字列を連結する](csharp/how-to/concatenate-multiple-strings.md)
### [文字列を DateTime に変換する](standard/base-types/parsing-datetime.md)
### [検索文字列](csharp/how-to/search-strings.md)
### [文字列の内容を変更する](csharp/how-to/modify-string-contents.md)
### [文字列を比較する](csharp/how-to/compare-strings.md)
### [安全にパターン マッチングを使用してキャスト、および演算子として](csharp/how-to/safely-cast-using-pattern-matching-is-and-as-operators.md)
...
### [Visual Studio での F# の概要](fsharp/get-started/get-started-visual-studio.md)
### [Visual Studio for Mac での F# の概要](fsharp/get-started/get-started-with-visual-studio-for-mac.md)
### [Visual Studio Code および Ionide での F# の概要](fsharp/get-started/get-started-vscode.md)
### [.NET Core CLI での F# の概要](fsharp/get-started/get-started-command-line.md)
...
#### [ファーストクラス関数](fsharp/introduction-to-functional-programming/first-class-functions.md)
### 非同期と同時実行プログラミング
...
### [基本型](fsharp/language-reference/basic-types.md)
...
### [スライス](fsharp/language-reference/slices.md)
...
#### [タプル](visual-basic/programming-guide/language-features/data-types/tuples.md)
...
##### [< 演算子](visual-basic/language-reference/operators/comparison-operators.md)
##### [<= 演算子](visual-basic/language-reference/operators/comparison-operators.md)
##### [> 演算子](visual-basic/language-reference/operators/comparison-operators.md)
##### [>= 演算子](visual-basic/language-reference/operators/comparison-operators.md)
...
##### [?() 演算子](visual-basic/language-reference/operators/null-conditional-operators.md)
##### [?.演算子](visual-basic/language-reference/operators/null-conditional-operators.md)
...
#### [要求された操作は利用できません (BC35000)](visual-basic/language-reference/error-messages/bc35000.md)
...
## 概要
### [ML.NET とは](machine-learning/what-is-mldotnet.md)
### [モデルのトレーニングの概念](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [映画のレコメンデーション (推奨)](machine-learning/tutorials/movie-recommmendation.md)
## [使い方ガイド](machine-learning/how-to-guides/index.md)
### データの準備
#### [カテゴリの特徴エンジニアリングを適用する](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
#### [テキストの特徴エンジニアリングを適用する](machine-learning/how-to-guides/train-model-textual-ml-net.md)
#### [多数の列を含むデータを読み込む](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
#### [複数のファイルからデータを読み込む](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
