...
Visual Basic のコマンド ライン コンパイラでは、Visual Studio 統合開発環境 (IDE) 内からプログラムをコンパイルする代わりに提供します。 このセクションには、Visual Basic のコンパイラ オプションの説明が含まれています。
