...
- [Visual Studio における Visual Basic の大きな変更](breaking-changes-in-visual-studio.md)\
...
- [Visual Basic の取得](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=inline+link&utm_content=download+vs2019)  
...
- [Visual Studio のフィードバック オプション](/visualstudio/ide/feedback-options)\
...
- [Office および SharePoint の開発](/visualstudio/vsto/office-and-sharepoint-development-in-visual-studio)\
