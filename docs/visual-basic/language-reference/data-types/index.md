...
|[Char](../../../visual-basic/language-reference/data-types/char-data-type.md)(1 文字)|<xref:System.Char>|2 バイト|0 ~ 65535 (符号なし)|  
...
|[Double](../../../visual-basic/language-reference/data-types/double-data-type.md)(倍精度浮動小数点数)|<xref:System.Double>|8 バイト|-1.79769313486231570 e + 308 から-4.94065645841246544 E-324 <sup>†</sup> (負の値の場合)<br /><br /> 4.94065645841246544 e-324 ~ 1.79769313486231570 E + 308 <sup>†</sup> (正の値)|  
...
|[Object](../../../visual-basic/language-reference/data-types/object-data-type.md)|<xref:System.Object>講義|32ビットプラットフォームで4バイト<br /><br /> 64ビットプラットフォームで8バイト|任意の型を型の変数に格納できます。`Object`|  
...
|[Single](../../../visual-basic/language-reference/data-types/single-data-type.md)(単精度浮動小数点数)|<xref:System.Single>|4 バイト|-3.4028235 e + 38 ~-1.401298 E-45 <sup>†</sup> (負の値の場合)<br /><br /> 1.401298 e-45 ~ 3.4028235 E + 38 <sup>†</sup> (正の値)|  
|[String](../../../visual-basic/language-reference/data-types/string-data-type.md)(可変長)|<xref:System.String>講義|実装するプラットフォームに依存|0 ~ 約20億の Unicode 文字|  
...
|[ユーザー定義](../../../visual-basic/language-reference/data-types/user-defined-data-type.md)データ|(から<xref:System.ValueType>継承)|実装するプラットフォームに依存|構造体の各メンバーには、そのデータ型によって決定され、他のメンバーの範囲とは独立した範囲があります。|  
...
- **ストレージのレイアウト。** メモリ内のストレージの順序は、宣言の順序と同じであると想定することはできません。 2バイトまたは4バイトの境界など、バイトのアラインメントについても想定することはできません。 クラスまたは構造体を定義していて、そのメンバーのストレージレイアウトを制御する必要がある場合<xref:System.Runtime.InteropServices.StructLayoutAttribute>は、クラスまたは構造体に属性を適用できます。  
  
### <a name="object-overhead"></a>オブジェクトのオーバーヘッド  
 基本データ型または複合データ型を参照するには、データ型に含まれるデータに加えて4バイトが使用されます。`Object`  
