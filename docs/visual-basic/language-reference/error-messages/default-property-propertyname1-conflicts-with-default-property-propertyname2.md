...
---
# <a name="default-property-propertyname1-conflicts-with-default-property-propertyname2-in-classname-and-so-should-be-declared-shadows"></a>既定のプロパティ '\<propertyname1>' は、'\<classname>' の既定のプロパティ '\<propertyname2>' と競合しているため、'Shadows' と宣言する必要があります
