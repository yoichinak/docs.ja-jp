...
---
# <a name="event-eventname1-cannot-implement-event-eventname2-on-interface-interface-because-their-delegate-types-delegate1-and-delegate2-do-not-match"></a>デリゲート型 '\<delegate1>' と '\<delegate2>' が一致しないため、イベント '\<eventname1>' では、インターフェイス '\<interface>' にイベント '\<eventname2>' を実装できません
