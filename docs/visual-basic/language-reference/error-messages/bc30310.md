...
---
# <a name="cannot-refer-to-name-because-it-is-a-member-of-the-value-typed-field-name-of-class-classname-which-has-systemmarshalbyrefobject-as-a-base-class"></a>'\<name>' は、'System.MarshalByRefObject' を基底クラスとして持つクラス '\<classname>' の値付きフィールド '\<name>' のメンバーであるため、参照できません
