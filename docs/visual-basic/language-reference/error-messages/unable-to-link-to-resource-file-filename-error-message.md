...
---
# <a name="unable-to-link-to-resource-file-filename-error-message"></a>リソースファイル '\<filename > ' にリンクできません: \<エラーメッセージ >
Visual Basic コンパイラは、アセンブリリンカー (Al.exe、Alink とも呼ばれます) を呼び出して、マニフェストを持つアセンブリを生成します。 リンカーが、アセンブリからネイティブな COM+ リソース ファイルにリンクするときにエラーが発生したことを報告しています。  
