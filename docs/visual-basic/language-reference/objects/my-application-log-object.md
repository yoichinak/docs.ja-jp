---
title: My.Application.Log オブジェクト (Visual Basic)
ms.date: 07/20/2015
helpviewer_keywords:
...
## <a name="remarks"></a>Remarks  
 ...
 詳細については、次を参照してください。[アプリケーションからのログ記録情報](../../../visual-basic/developing-apps/programming/log-info/index.md)します。  
