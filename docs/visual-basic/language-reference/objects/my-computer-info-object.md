---
title: My.Computer.Info オブジェクト (Visual Basic)
ms.date: 07/20/2015
helpviewer_keywords:
...
## <a name="remarks"></a>Remarks  
 プロパティについては、`My.Computer.Info`オブジェクトを参照してください<xref:Microsoft.VisualBasic.Devices.ComputerInfo>します。  
