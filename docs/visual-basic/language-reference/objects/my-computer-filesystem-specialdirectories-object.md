...
## <a name="remarks"></a>Remarks  
 ...
 詳細については、[My Documents ディレクトリの内容を取得する方法](../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-retrieve-the-contents-of-the-my-documents-directory.md)に関するページを参照してください。  
