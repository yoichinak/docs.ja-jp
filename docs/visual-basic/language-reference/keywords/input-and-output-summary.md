...
|ファイル属性の設定または取得|<xref:Microsoft.VisualBasic.FileSystem.FileAttr%2A>では、 <xref:Microsoft.VisualBasic.FileSystem.GetAttr%2A>では、 <xref:Microsoft.VisualBasic.FileSystem.SetAttr%2A>|  
