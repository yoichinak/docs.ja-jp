...
|時刻を時、分、または秒に変換|<xref:Microsoft.VisualBasic.DateAndTime.Hour%2A>では、 <xref:Microsoft.VisualBasic.DateAndTime.Minute%2A>では、 <xref:Microsoft.VisualBasic.DateAndTime.Second%2A>|  
