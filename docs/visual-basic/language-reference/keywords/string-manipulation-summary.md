...
|文字列をすべて小文字または大文字に変換|<xref:Microsoft.VisualBasic.Strings.Format%2A>では、 <xref:Microsoft.VisualBasic.Strings.LCase%2A>では、 <xref:Microsoft.VisualBasic.Strings.UCase%2A>|  
