...
2. Open a new Windows Application project by clicking **New** on the **File** menu, and then clicking **Project**. **[新しいプロジェクト]** ダイアログ ボックスが表示されます。  
...
3. Add equivalent `Const` statements to your class or module to make these constants available to your application. (例:  
...
1. Open a new Windows Application project by clicking **New** on the **File** menu, and then clicking **Project**. **[新しいプロジェクト]** ダイアログ ボックスが表示されます。  
...
11. F5 キーを押してアプリケーションを起動します。 The main form appears.  
