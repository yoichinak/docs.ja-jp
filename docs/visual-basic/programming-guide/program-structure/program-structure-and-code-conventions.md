...
このセクションは、一般的な Visual Basic プログラムの構造が導入されています、単純な Visual Basic プログラムを "Hello, World" を提供し、Visual Basic コードの規則について説明します。 コード規則は、プログラムのロジックではなくプログラムの物理的な構造と外観に焦点を合わせた提案です。 コード規則に従うと、コードの読み取り、理解、保守が簡単になります。 コード規則には、以下の内容が含まれます。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 コード エディターに折りたたんで Visual Basic でのコードのセクションを非表示にする方法を示します。  
 ...
 角かっこを使用する方法について説明します (`[]`) を Visual Basic のキーワードにもなる変数名を区切るためにします。  
...
## <a name="related-sections"></a>関連項目  
 ...
 Visual basic のコーディング規則の標準を提供します。  
