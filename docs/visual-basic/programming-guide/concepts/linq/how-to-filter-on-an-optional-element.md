...
---
# <a name="how-to-filter-on-an-optional-element-visual-basic"></a>方法 : 省略可能な要素にフィルターを適用する
...
- [基本的なクエリ (LINQ to XML) (ビジュアル ベーシック)](../../../../visual-basic/programming-guide/concepts/linq/basic-queries-linq-to-xml.md)
...
- [プロジェクション操作](../../../../visual-basic/programming-guide/concepts/linq/projection-operations.md)
