---
title: '方法: Linq TO XML の例 (Visual Basic) をビルドします。'
ms.date: 07/20/2015
...
ms.locfileid: "62054977"
---
# <a name="how-to-build-linq-to-xml-examples-visual-basic"></a>方法: Linq TO XML の例 (Visual Basic) をビルドします。
