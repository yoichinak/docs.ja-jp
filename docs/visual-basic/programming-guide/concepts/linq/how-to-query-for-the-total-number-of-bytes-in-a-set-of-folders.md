...
---
# <a name="how-to-query-for-the-total-number-of-bytes-in-a-set-of-folders-linq-visual-basic"></a>方法 : フォルダー のセット内のバイトの合計数をクエリする (LINQ) (Visual Basic)
...
名前空間の`Imports`ステートメントを使用して、Visual Basic コンソール アプリケーション プロジェクトを作成します。
