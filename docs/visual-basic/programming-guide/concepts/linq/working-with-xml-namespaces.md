...
|[グローバル名前空間の使用 (Visual Basic) (LINQ to XML)](../../../../visual-basic/programming-guide/concepts/linq/working-with-global-namespaces-linq-to-xml.md)|Visual Basic のグローバル名前空間のセマンティクスと、グローバル名前空間を使用する理由について説明します。|  
|[方法: 名前空間内の XML に対するクエリを記述する (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-write-queries-on-xml-in-namespaces.md)|Visual Basic の LINQ to XML クエリで XML 名前空間を指定する方法について説明します。|  
