...
ms.locfileid: "74354223"
---
# <a name="details-of-office-open-xml-wordprocessingml-documents-visual-basic"></a>Office Open XML WordprocessingML ドキュメントの詳細 (Visual Basic)
...
|[Office Open XML ドキュメント パーツを出力する例 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)|Office Open XML WordprocessingML ドキュメントを開き、パーツをコンソールに出力する例について説明します。|  
