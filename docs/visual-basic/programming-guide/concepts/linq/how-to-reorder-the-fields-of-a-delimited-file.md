---
title: '方法: 区切られたファイルのフィールドの順序を変更する (LINQ) (Visual Basic)'
ms.date: 07/20/2015
...
ms.locfileid: "72582796"
---
# <a name="how-to-reorder-the-fields-of-a-delimited-file-linq-visual-basic"></a>方法: 区切られたファイルのフィールドの順序を変更する (LINQ) (Visual Basic)
