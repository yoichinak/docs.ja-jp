---
title: '方法: (LINQ to XML) の要素のコレクションを取得する (Visual Basic)'
ms.date: 07/20/2015
...
ms.locfileid: "62021376"
---
# <a name="how-to-retrieve-a-collection-of-elements-linq-to-xml-visual-basic"></a>方法: (LINQ to XML) の要素のコレクションを取得する (Visual Basic)
