...
```  
 ...
 この例では、`M:System.Xml.Linq.XElement.Element` メソッドを使用しています。このメソッドは「[方法: 単一の子要素を取得する (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-retrieve-a-single-child-element-linq-to-xml.md)」で紹介されています。 また、キャストを使用して、`M:System.Xml.Linq.XElement.Element` メソッドによって返された要素の値を取得します。  
