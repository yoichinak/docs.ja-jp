...
|[LINQ to XML クラスの概要 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-classes-overview.md)|[!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] クラスの概要について説明します。|  
...
|[方法: Linq TO XML の例 (Visual Basic) をビルドします。](../../../../visual-basic/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)|含まれています、 `Imports` linq TO XML の例をビルドするために必要なステートメント。|  
