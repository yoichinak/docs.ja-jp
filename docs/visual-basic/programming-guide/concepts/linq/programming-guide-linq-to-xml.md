...
## <a name="who-should-read-this-documentation"></a>このドキュメントの対象読者  
 このドキュメントは、Visual Basic や .NET Framework の基本的な側面について既に理解している開発者を対象としています。  
 ...
 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] は、ジェネリック クラスに大きく依存しています。 そのため、ジェネリック型とジェネリック クラスの使用について理解することが非常に重要です。 詳細については、「[Visual Basic におけるジェネリック型 (Visual Basic)](../../../../visual-basic/programming-guide/language-features/data-types/generic-types.md)」を参照してください。  
