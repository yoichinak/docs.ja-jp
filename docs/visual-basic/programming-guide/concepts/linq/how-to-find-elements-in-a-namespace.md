---
title: '方法: 名前空間内の要素の検索 (XPath LINQ to XML) (Visual Basic)'
ms.date: 07/20/2015
...
ms.locfileid: "72250112"
---
# <a name="how-to-find-elements-in-a-namespace-xpath-linq-to-xml-visual-basic"></a>方法: 名前空間内の要素の検索 (XPath LINQ to XML) (Visual Basic)
