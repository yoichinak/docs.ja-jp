...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [方法 : ストアド プロシージャの呼び出し](../../../../visual-basic/programming-guide/language-features/linq/how-to-call-a-stored-procedure-by-using-linq.md)  
 SQL Server データベースに接続し、LINQ を使用してストアド プロシージャを呼び出す方法の例を示します。  
  
 [方法: データベースのデータの変更](../../../../visual-basic/programming-guide/language-features/linq/how-to-modify-data-in-a-database-by-using-linq.md)  
