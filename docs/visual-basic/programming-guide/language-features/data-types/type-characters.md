...
|Identifier type character|データの種類|例|  
|-------------------------------|---------------|-------------|  
|`%`|`Integer`|`Dim L%`|  
|`&`|`Long`|`Dim M&`|  
...
|Textual form of literal|Default data type|例|  
|-----------------------------|-----------------------|-------------|  
...
|Literal type character|データの種類|例|  
|----------------------------|---------------|-------------|  
|`S`|`Short`|`I = 347S`|
|`I`|`Integer`|`J = 347I`|
|`L`|`Long`|`K = 347L`|
...
|Number base|プレフィックス|Valid digit values|例|
|-----------------|------------|------------------------|-------------|
|16 進数 (基数 16)。|`&H`|0-9 and A-F|`&HFFFF`|
