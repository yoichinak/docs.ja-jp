...
|リテラル|リテラルの型文字で指定する場合は、「[Type Characters (型文字)](../../../../visual-basic/programming-guide/language-features/data-types/type-characters.md)」の「型文字」を参照してください<br /><br /> `Dim searchChar As Char = "."`  `C`|  
