---
title: "' <interfacename1>. <membername> ' を実装することはできません。一部の型引数では、実装が ' <interfacename2>. <membername> ' の実装と競合する可能性があります"
ms.date: 07/20/2015
f1_keywords:
- bc32125
- vbc32125
...
---
# <a name="cannot-implement-interfacename1membername-because-its-implementation-could-conflict-with-the-implementation-for-interfacename2membername-for-some-type-arguments"></a>' \<interfacename1 >. \< membername > ' を実装できません。実装すると、一部の型引数に対して ' \<interfacename2 >. \<membername > ' の実装と競合する可能性があります。
