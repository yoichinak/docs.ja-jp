...
---
# <a name="cannot-inherit-interface-interfacename1-because-the-interface-interfacename2-from-which-it-inherits-could-be-identical-to-interface-interfacename3-for-some-type-arguments"></a>継承元のインターフェイス ' \<interfacename2 > ' が、一部の型引数のインターフェイス ' \<interfacename3 > ' と同一である可能性があるため、インターフェイス ' @no__t 0interfacename1 > ' を継承できません
