...
2. ジェネリック モジュールの機能が必要な場合は、ジェネリック クラスであればそれに最も近い機能を使用できます。 `Module`ステートメントではなく、[Class ステートメント](../../visual-basic/language-reference/statements/class-statement.md)を使用してください。
