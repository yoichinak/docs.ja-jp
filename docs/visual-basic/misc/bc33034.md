...
---
# <a name="return-and-parameter-types-of-logicaloperator-must-be-typename-to-be-used-in-a-shortcircuitoperator-expression"></a>'\<logicaloperator>' の戻り値およびパラメーターの型を'\<shortcircuitoperator>' 式で使用するには、'\<typename>' にする必要があります
