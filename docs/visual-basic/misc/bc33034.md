---
title: '<logicaloperator>' の戻り値およびパラメータの型を'<shortcircuitoperator>' 式で使用するには、'<typename>' にしなければなりません。
ms.date: 07/20/2015
f1_keywords:
- vbc33034
- bc33034
...
---
# <a name="return-and-parameter-types-of-logicaloperator-must-be-typename-to-be-used-in-a-shortcircuitoperator-expression"></a>'\<logicaloperator>' の戻り値およびパラメータの型を'\<shortcircuitoperator>' 式で使用するには、'\<typename>' にしなければなりません。
