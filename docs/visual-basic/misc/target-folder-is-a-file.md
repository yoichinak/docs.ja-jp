...
- [ファイル、ディレクトリ、および Visual Basic でドライブのプロパティ](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/as4xcs58(v=vs.100))
- [方法: Visual Basic でファイルの絶対パスを確認します。](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/e00wt2d8(v=vs.100))
