...
ms.locfileid: "58051460"
---
# <a name="typename-in-assembly-assemblyname-has-been-forwarded-to-itself-and-so-is-an-unsupported-type"></a>'\<typename >' アセンブリで'\<assemblyname >' はそれ自体に転送されましたのではサポートされていない型
