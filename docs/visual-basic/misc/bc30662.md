...
---
# <a name="attribute-attributename-cannot-be-applied-to-membername-because-the-attribute-is-not-valid-on-this-declaration-type"></a>属性 '\<attributename > ' は、この宣言型\<では有効でないため、' membername > ' に適用できません
