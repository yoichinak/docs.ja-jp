...
ms.locfileid: "61788532"
---
# <a name="methodname-is-not-accessible-in-this-context-because-the-return-type-is-not-accessible"></a>'\<methodname >' に戻り値の型にアクセスできないために、このコンテキストでアクセスできません。
