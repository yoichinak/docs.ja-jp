---
title: 戻り値の型にアクセスできないため、' <methodname> ' はこのコンテキストではアクセスできません。
ms.date: 07/20/2015
f1_keywords:
- bc36665
- vbc36666
...
ms.locfileid: "72581735"
---
# <a name="methodname-is-not-accessible-in-this-context-because-the-return-type-is-not-accessible"></a>戻り値の型にアクセスできないため、このコンテキストで ' \<methodname > ' にアクセスすることはできません
