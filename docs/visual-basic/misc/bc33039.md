---
title: '<operator>' の戻り値型およびパラメーター型は、'For' ステートメントで使用するためには '<typename>' である必要があります
ms.date: 07/20/2015
f1_keywords:
- vbc33039
- bc33039
...
---
# <a name="return-and-parameter-types-of-operator-must-be-typename-to-be-used-in-a-for-statement"></a>'\<operator>' の戻り値型およびパラメーター型は、'For' ステートメントで使用するためには '\<typename>' である必要があります
