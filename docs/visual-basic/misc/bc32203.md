---
title: '<method1>' はベース メソッドのアクセスを展開するので、'<method2>' をオーバーライドできません。
ms.date: 07/20/2015
f1_keywords:
- vbc32203
- bc32203
...
---
# <a name="method1-cannot-override-method2-because-it-expands-the-access-of-the-base-method"></a>'\<method1>' はベース メソッドのアクセスを展開するので、'\<method2>' をオーバーライドできません。
