...
- パラメーターなしか、3 つ以上のパラメータを指定する必要がある場合は、演算子を定義するのではなく、[Function ステートメント](../../visual-basic/language-reference/statements/function-statement.md)を使用して Function プロシージャを定義する必要があります。
