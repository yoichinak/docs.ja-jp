---
title: 型 '<internaltypename>' のアクセスを <region> '<regionname>' へ展開しているため、'<derivedtypename>' は <type>'<constructedbasetypename>' から継承できません。
ms.date: 07/20/2015
f1_keywords:
- vbc30921
- BC30921
...
---
# <a name="derivedtypename-cannot-inherit-from-type-constructedbasetypename-because-it-expands-the-access-of-type-internaltypename-to-region-regionname"></a>型 '\<internaltypename>' のアクセスを \<region> '\<regionname>' へ展開しているため、'\<derivedtypename>' は \<type>'\<constructedbasetypename>' から継承できません。
