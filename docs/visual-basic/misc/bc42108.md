...
---
# <a name="variable-variablename-is-passed-by-reference-before-it-has-been-assigned-a-value-structure-variable"></a>変数 '\<variablename >' (構造体変数) の値が割り当てられる前に、参照によって渡される
