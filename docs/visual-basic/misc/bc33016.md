---
title: "演算子 '<operator>' には、1 個または 2 個のパラメータを指定しなければなりません。"
ms.date: 07/20/2015
f1_keywords:
- bc33016
- vbc33016
...
---
# <a name="operator-operator-must-have-either-one-or-two-parameters"></a>演算子 '\<operator>' には、1 個または 2 個のパラメータを指定しなければなりません。
