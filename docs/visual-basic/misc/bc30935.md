---
title: "クラス ' <classname> ' には同じ名前とシグネチャを持つ複数のメンバーが含まれているため、このシグネチャに一致するメンバー ' <classname>. <procedurename> ' をオーバーライドすることはできません: <signaturelist>"
ms.date: 07/20/2015
f1_keywords:
- bc30935
- vbc30935
