---
title: クラス '<classname><procedurename>'には同じ名前とシグネチャを持つ複数のメンバーが含まれているため、このシグネチャに一致するメンバー'.'をオーバーライドすることは<classname>できません:<signaturelist>
ms.date: 07/20/2015
f1_keywords:
- bc30935
- vbc30935
...
ms.locfileid: "69664805"
---
# <a name="member-classnameprocedurename-that-matches-this-signature-cannot-be-overridden-because-the-class-classname-contains-multiple-members-with-this-same-name-and-signature-signaturelist"></a>メンバー '\<classname >。\<クラス '\<classname > ' には同じ名前とシグネチャ: \<signaturelist を持つ複数のメンバーが含まれているため、このシグネチャに一致する procedurename > ' をオーバーライドすることはできません >
