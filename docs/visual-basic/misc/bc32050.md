---
title: "'<genericprocedurename>' の型パラメータ '<typeparametername>' を推論できません。"
ms.date: 07/20/2015
f1_keywords:
- vbc32050
- bc32050
...
---
# <a name="type-parameter-typeparametername-for-genericprocedurename-cannot-be-inferred"></a>'\<genericprocedurename>' の型パラメータ '\<typeparametername>' を推論できません。
