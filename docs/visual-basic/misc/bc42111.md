...
ms.locfileid: "64588278"
---
# <a name="static-variable-variablename-declared-without-an-as-clause-type-of-object-assumed"></a>静的変数 '\<variablename >' に 'As' 句がありません宣言された型の 'Object' と見なされます。
