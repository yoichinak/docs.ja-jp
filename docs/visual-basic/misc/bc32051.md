---
title: "' @No__t-1 ' の型パラメーター ' <typeparametername> ' に対して型引数を推論できませんでした"
ms.date: 07/20/2015
f1_keywords:
- vbc32051
- bc32051
...
---
# <a name="type-argument-inference-failed-for-type-parameter-typeparametername-of-genericproceduresignature"></a>' @No__t-1genericproceduresignature > ' の型パラメーター ' \<typeparametername > ' に対する型引数の推定が失敗しました

**エラー ID:** BC32051

' @No__t-1genericproceduresignature > ' の型パラメーター ' \<typeparametername > ' に対する型引数の推定に失敗しました。 パラメーター ' \<parametername > ' に渡された引数から型引数を推論できませんでした。
