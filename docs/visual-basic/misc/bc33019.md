...
ms.locfileid: "59340894"
---
# <a name="only-conversion-operators-can-be-declared-keyword"></a>変換演算子のみを宣言することができます '\<キーワード >'
