---
title: "メンバー '<interfacename>。インターフェイス '<interfacename>' に同じ名前とシグネチャを持つ複数のメンバーが含まれているため、このシグネチャに一致する<procedurename>' を実装することはできません: <signaturelist>"
ms.date: 07/20/2015
f1_keywords:
- vbc30937
- bc30937
