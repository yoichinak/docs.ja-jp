---
title: 単項演算子のパラメータの型は、それを含む型 '<typename>' でなければなりません。
ms.date: 07/20/2015
f1_keywords:
- vbc33020
- bc33020
...
---
# <a name="parameter-type-of-this-unary-operator-must-be-the-containing-type-typename"></a>単項演算子のパラメータの型は、それを含む型 '<typename>' でなければなりません。
