---
title: 引数の値 '<pathname>' パス名に無効な文字が含まれています
ms.date: 07/20/2015
f1_keywords:
...
ms.locfileid: "61977070"
---
# <a name="argument-value-pathname-contains-characters-that-are-not-valid-in-a-path-name"></a>引数の値 '\<pathname >' のパス名に無効な文字が含まれています
