---
title: "メンバ '<membername1>' は、ベースクラス '<baseclassname>' のメンバと競合する '<implicitmembername>' を暗黙的に宣言しています。"
ms.date: 07/20/2015
f1_keywords:
- vbc40022
- bc40022
...
---
# <a name="member-membername1-implicitly-declares-implicitmembername-which-conflicts-with-a-member-in-the-base-class-baseclassname"></a>メンバ '\<membername1>' は、ベースクラス '\<baseclassname>' のメンバと競合する '\<implicitmembername>' を暗黙的に宣言しています。
