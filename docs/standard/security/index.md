...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [アンマネージ コードの安全なコーディングのガイドライン](../../../docs/framework/security/secure-coding-guidelines-for-unmanaged-code.md)  
 アンマネージ コードを呼び出す際のベスト プラクティスとセキュリティに関する注意事項について、いくつか説明します。  
