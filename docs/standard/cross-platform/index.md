---
title: .NET Framework による複数のプラットフォーム用に開発
ms.date: 07/18/2018
...
ms.locfileid: "75938029"
---
# <a name="developing-for-multiple-platforms-with-the-net-framework"></a>.NET Framework による複数のプラットフォーム用に開発
