...
|セクションの数|[説明]|
|------------------------|-----------------|
|1 つのセクション|書式指定文字列はすべての値に適用されます。|
|2 つのセクション|最初のセクションが正の値とゼロに適用され、2 番目のセクションが負の値に適用されます。<br /><br /> 書式設定対象の数値が負の数値であるが、2 番目のセクションの書式指定に従って丸めた結果ゼロになる場合には、1 番目のセクションの書式に従ってこのゼロが書式設定されます。|
