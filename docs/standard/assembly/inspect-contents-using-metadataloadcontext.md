...
完全なコード例については、「[MetadataLoadContext を使用してアセンブリの内容を検査する](https://docs.microsoft.com/samples/dotnet/samples/inspect-assembly-contents-using-metadataloadcontext/)」をご覧ください。
