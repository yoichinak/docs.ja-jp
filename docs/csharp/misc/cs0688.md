...
'method1' はリンク要求を含んでいますが、リンク要求を含んでいない 'method2' をオーバーライドまたは実装します。 セキュリティに問題が発生する可能性があります。  
 ...
 派生クラス メソッドに設定されているリンク要求は、基底クラス メソッドを呼び出すと簡単に迂回できます。 このセキュリティ ホールをふさぐには、基底クラス メソッドでもリンク要求を使用する必要があります。 詳細については、[Demand とを参照してください。LinkDemand](../../framework/misc/securing-wrapper-code.md#demand-vs-linkdemand)します。  
