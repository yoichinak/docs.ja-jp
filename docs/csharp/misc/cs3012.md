...
`[module:System.CLSCompliant(true)]`を通じて、モジュールが共通言語仕様 (CLS) に準拠するためには、 [/target:module](../../csharp/language-reference/compiler-options/target-module-compiler-option.md) コンパイラ オプションを使用してビルドする必要があります。 CLS の詳細については、[Language Independence and Language-independent Components](../../../docs/standard/language-independence-and-language-independent-components.md)を参照してください。
