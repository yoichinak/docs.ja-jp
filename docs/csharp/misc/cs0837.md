...
演算子 'is' または 'as' の最初のオペランドを、ラムダ式または匿名メソッドにすることはできません。  
 ...
 ラムダ式と匿名メソッドは、 [is](../../csharp/language-reference/operators/type-testing-and-cast.md#is-operator) または [as](../../csharp/language-reference/operators/type-testing-and-cast.md#as-operator)の左側に使用できません。
