...
イベント 'event' は += または -= の左側でのみ使用できます
 ...
 [event](../../csharp/language-reference/keywords/event.md) が正しく呼び出されませんでした。 詳細については、次を参照してください。[イベント](../../csharp/programming-guide/events/index.md)と[デリゲート](../../csharp/programming-guide/delegates/index.md)です。
