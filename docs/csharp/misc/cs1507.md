...
ms.locfileid: "72523770"
---
# <a name="compiler-error-cs1507"></a>コンパイラ エラー CS1507
モジュールをビルド中にリソース ファイル 'file' にリンクできません  
  
 [-linkresource](../language-reference/compiler-options/linkresource-compiler-option.md)は、 [/target: module](../language-reference/compiler-options/target-module-compiler-option.md)と同じコンパイルで使用されましたが、これは許可されていません。 たとえば、次のオプションでは CS1507 が生成されます。  
