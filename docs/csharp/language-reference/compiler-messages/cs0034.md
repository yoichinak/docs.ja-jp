...
ms.locfileid: "67744211"
---
# <a name="compiler-error-cs0034"></a>コンパイラ エラー CS0034
型 'type1' および 'type2' のオペランドの演算子 'operator' があいまいです  
  
 1 つの演算子が 2 つのオブジェクトに使用され、複数の変換が見つかりました。 変換は一意である必要があるため、キャストを行うか、いずれかの変換を明示的にする必要があります。 詳細については、「[User-defined conversion operators](../../../csharp/language-reference/operators/user-defined-conversion-operators.md)」(ユーザー定義の変換演算子) を参照してください。  
