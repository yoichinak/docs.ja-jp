...
アセンブリ 'assembly' を署名しているときに暗号に失敗しました — 'reason'  
 ...
 詳細については、[方法:厳密な名前でアセンブリに署名する](../../../framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md)」、「[/keyfile (C# コンパイラ オプション)](../compiler-options/keyfile-compiler-option.md)」、「[/delaysign (C# コンパイラ オプション)](../compiler-options/delaysign-compiler-option.md)」を参照してください。  
