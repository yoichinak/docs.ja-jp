...
- [ 属性の代わりに ](../compiler-options/keyfile-compiler-option.md)-keyfile (C# コンパイラ オプション)<xref:System.Reflection.AssemblyKeyFileAttribute>。  
  
- [ の代わりに ](../compiler-options/keycontainer-compiler-option.md)-keycontainer (C# コンパイラ オプション)<xref:System.Reflection.AssemblyKeyNameAttribute>。  
  
- [ の代わりに ](../compiler-options/delaysign-compiler-option.md)-delaysign (C# コンパイラ オプション)<xref:System.Reflection.AssemblyDelaySignAttribute>。  
