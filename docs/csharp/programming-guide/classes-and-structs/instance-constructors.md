...
## <a name="example-2"></a>例 2  
 ...
 `age` の既定値は `0`、`name` の既定値は `null` であることに注意してください。 既定値について詳しくは、「[既定値の一覧表](../../language-reference/keywords/default-values-table.md)」をご覧ください。  
