...
## <a name="walking-the-call-stack"></a>コール スタック ウォークの実行  
 ...
 ![コードアクセスセキュリティ](../../../docs/framework/misc/media/slide-10a.gif "slide_10a")  
セキュリティ スタック ウォーク  
...
|[透過的セキュリティコード、レベル2](../../../docs/framework/misc/security-transparent-code-level-2.md)|.NET Framework 4 のセキュリティ透過性モデルについて説明します。|  
