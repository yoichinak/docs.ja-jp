...
ローディング中に [ICorProfilerInfo5::SetEventMask2](../../../../docs/framework/unmanaged-api/profiling/cor-prf-monitor-enumeration.md) メソッドに対してプロファイラーが指定できる [COR_PRF_MONITOR](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo5-seteventmask2-method.md) 列挙の内容の他に、フラグを提供します。  
...
|`COR_PRF_HIGH_ADD_ASSEMBLY_REFERENCES`|CLR アセンブリ参照クロージャ ウォーク中にアセンブリ参照を追加するための [ICorProfilerCallback6::GetAssemblyReference](../../../../docs/framework/unmanaged-api/profiling/icorprofilercallback6-getassemblyreferences-method.md) コールバックを制御します。|  
...
|`COR_PRF_HIGH_REQUIRE_PROFILE_IMAGE`|プロファイルが強化されたイメージを必要とするすべての `COR_PRF_HIGH_MONITOR` フラグを表しています。 これは、`COR_PRF_REQUIRE_PROFILE_IMAGE`COR_PRF_MONITOR[ 列挙体の ](../../../../docs/framework/unmanaged-api/profiling/cor-prf-monitor-enumeration.md) フラグに対応します。|  
...
`COR_PRF_HIGH_MONITOR` フラグは、`pdwEventsHigh`ICorProfilerInfo5::GetEventMask2[ および ](icorprofilerinfo5-geteventmask2-method.md)ICorProfilerInfo5::SetEventMask2[ メソッドの ](icorprofilerinfo5-seteventmask2-method.md) パラメーターと共に使用します。  
