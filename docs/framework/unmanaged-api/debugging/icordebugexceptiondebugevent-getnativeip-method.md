...
---
# <a name="icordebugexceptiondebugeventgetnativeip-method"></a>いい Exceptiondebugevent:: GetNativeIP メソッド
...
|[MANAGED_EXCEPTION_CATCH_HANDLER_FOUND](../../../../docs/framework/unmanaged-api/debugging/cordebugrecordformat-enumeration.md)|[Getstackpointer](../../../../docs/framework/unmanaged-api/debugging/icordebugexceptiondebugevent-getstackpointer-method.md)メソッドによって示されるフレーム内で `catch` ハンドラーの実行が開始されるコードアドレス。|  
