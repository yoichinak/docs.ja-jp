...
## <a name="parameters"></a>パラメーター  
 `pbAttached`  
 [out] デバッガーがプロセスにアタッチされている場合は `true`。それ以外の場合は、`false`ます。  
  
## <a name="return-value"></a>戻り値  
  
|HRESULT|説明|  
|-------------|-----------------|  
|S_OK|`IsDebuggerAttached` が正常に返されました。|  
...
## <a name="remarks"></a>Remarks  
 `IsDebuggerAttached` を使用すると、ホストは CLR に対してクエリを実行し、デバッガーがプロセスにアタッチされているかどうかを判断できます。  
