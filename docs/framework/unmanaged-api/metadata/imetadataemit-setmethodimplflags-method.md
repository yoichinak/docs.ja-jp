...
指定したトークンによって参照される継承されたメソッド実装のメタデータ シグネチャを設定または更新します。  
...
## <a name="parameters"></a>パラメーター  
 ...
 `dwImplFlags`  
 [in]メソッド実装機能を指定する[CorMethodImpl](../../../../docs/framework/unmanaged-api/metadata/cormethodimpl-enumeration.md)列挙型の値の組み合わせ。  
