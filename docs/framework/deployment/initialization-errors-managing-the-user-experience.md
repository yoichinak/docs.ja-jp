...
- .NET Framework 3.5 (以前) のアプリケーションの場合:.NET Framework 4 以降のバージョンをサポートするようにアプリケーションを構成します (手順は[こちら](../../../docs/framework/migration-guide/how-to-configure-an-app-to-support-net-framework-4-or-4-5.md)でご覧ください)。
