...
## <a name="flowchart-workflow-structure"></a>フローチャート ワークフロー構造
...
## <a name="types-of-flow-nodes"></a>フローノードのタイプ
...
### <a name="creating-a-basic-activity-sequence-with-a-flowstep-node"></a>FlowStep ノードを使用した基本アクティビティシーケンスの作成
...
### <a name="creating-a-conditional-flowchart-with-a-flowdecision-node"></a>条件フローチャートを作成する、 FlowDecision ノード
...
### <a name="creating-an-exclusive-switch-with-a-flowswitch-node"></a>フロースイッチ ノードを使用した排他的スイッチの作成
