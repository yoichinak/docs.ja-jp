...
1. <xref:System.ServiceModel.Activities.Send> と <xref:System.ServiceModel.Activities.Receive> を <xref:System.Activities.Statements.Interop> アクティビティで使用することはできません。  
  
2. <xref:System.Workflow.Activities.WebServiceInputActivity>、<xref:System.Workflow.Activities.WebServiceOutputActivity>、および <xref:System.Workflow.Activities.WebServiceFaultActivity> を <xref:System.Activities.Statements.Interop> アクティビティ内で使用することはできません。  
  
3. <xref:System.Workflow.Activities.InvokeWorkflowActivity> を <xref:System.Activities.Statements.Interop> アクティビティ内で使用することはできません。  
  
4. <xref:System.Workflow.ComponentModel.SuspendActivity> を <xref:System.Activities.Statements.Interop> アクティビティ内で使用することはできません。  
