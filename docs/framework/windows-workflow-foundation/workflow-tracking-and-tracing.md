...
## <a name="workflow-tracking-infrastructure"></a>ワークフロー追跡インフラストラクチャ  
 ...
 追跡インフラストラクチャの高レベルのビューを次の図で表示します。  
  
 ![ワークフロー追跡インフラストラクチャを示すスクリーン ショット。](./media/workflow-tracking-and-tracing/workflow-tracking-infrastructure.gif "WV")  
