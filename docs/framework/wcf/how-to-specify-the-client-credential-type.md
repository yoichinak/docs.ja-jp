...
1. [@No__t-1System >](../configure-apps/file-schema/wcf/system-servicemodel.md)要素を構成ファイルに追加します。  
...
4. [@No__t-1binding >](../misc/binding.md)要素を追加し、`name` 属性を適切な値に設定します。 この例では、"SecureBinding" という名前を使用します。  
