...
-   [!INCLUDE[iis601](../../../../includes/iis601-md.md)] [!INCLUDE[ws2003](../../../../includes/ws2003-md.md)]します。 [!INCLUDE[iis601](../../../../includes/iis601-md.md)] 強化されたスケーラビリティ、信頼性、およびアプリケーションの分離を提供する高度なプロセス モデルを提供します。 この環境では、HTTP 通信のみを使用する WCF サービスの運用環境のデプロイに適しています。  
