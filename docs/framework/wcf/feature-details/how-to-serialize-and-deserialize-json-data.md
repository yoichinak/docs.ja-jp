...
ms.locfileid: "72180222"
---
# <a name="how-to-use-datacontractjsonserializer"></a>方法: DataContractJsonSerializer を使用する
...
2. @No__t-1 を使用して、@no__t 0 オブジェクトをメモリストリームにシリアル化します。  
