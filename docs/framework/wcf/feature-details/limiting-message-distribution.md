...
-   コード スニペットと関連情報については、、[ピア チャネルのブログ](https://go.microsoft.com/fwlink/?LinkID=114531)を参照してください。  
...
-   コード スニペットと関連情報については、、[ピア チャネルのブログ](https://go.microsoft.com/fwlink/?LinkID=114532)を参照してください。  
