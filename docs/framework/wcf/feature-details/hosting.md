...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 インターネット インフォメーション サービスで Windows Communication Foundation (WCF) サービスをホストする方法について説明します。 または[Windows Server AppFabric](https://go.microsoft.com/fwlink/?LinkId=196496)します。  
 ...
 .Svc ファイルを使用することがなく IIS または WAS で WCF サービスがホストされる方法について説明します。  
