...
```  
 ...
 サービスに適用できる属性を実装して、データ コントラクト リゾルバーを宣言によって指定できます。  詳細については、次を参照してください。、 [KnownAssemblyAttribute](../../../../docs/framework/wcf/samples/knownassemblyattribute.md)サンプル。 このサンプルは"KnownAssembly"という名前の属性を実装するカスタム データ コントラクト リゾルバー サービスの動作に追加します。  
