...
3. Visual Studio 2012 の[はじめにチュートリアル](../getting-started-tutorial.md)で作成したサンプルを開きます。 サービスを作成できるようにするには、Visual Studio 2012 を管理者として実行する必要があることに注意してください。 WCF サンプルがインストールされている場合は、チュートリアルで作成した完成したプロジェクトを含む[入門サンプル](../samples/getting-started-sample.md)を開くことができます。
