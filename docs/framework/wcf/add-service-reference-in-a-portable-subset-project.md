...
10. コメントは、アセンブリおよびコード ジェネレーターのバージョンを識別するファイルの先頭に挿入されます。`// This code was auto-generated by Microsoft.VisualStudio.Portable.AddServiceReference, version 1.0.0.0`  
...
14. <xref:System.ServiceModel.MessageContractAttribute.IsWrapped%2A> ポータブル サブセット プロジェクトではサポートされません。  
