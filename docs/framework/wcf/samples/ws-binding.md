...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [WS 2007 フェデレーション HTTP バインディング](../../../../docs/framework/wcf/samples/ws-2007-federation-http-binding.md)  
 <xref:System.ServiceModel.WS2007FederationHttpBinding> の使用方法を示します。  
  
 [WS デュアル Http](../../../../docs/framework/wcf/samples/ws-dual-http.md)  
 `WSDualHttpBinding` バインディングを構成する方法を示します。  
  
 [MTOM エンコーディング](../../../../docs/framework/wcf/samples/mtom-encoding.md)  
