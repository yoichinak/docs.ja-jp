...
---
# <a name="security-of-wsfederationhttpbinding"></a>\<wsFederationHttpBinding > のセキュリティ > の \<
...
|要素|説明|  
|-------------|-----------------|  
|[\< メッセージ >](message-element-of-wsfederationhttpbinding.md)|メッセージ レベル セキュリティの設定を定義します。 この要素は <xref:System.ServiceModel.Configuration.FederatedMessageSecurityOverHttpElement> 型です。|  
