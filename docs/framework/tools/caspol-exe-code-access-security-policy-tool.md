...
|**-e** **[xecution]** {**on** &#124; **off**}|コードの実行が開始される前に実行許可を確認する機構のオンとオフを切り替えます。 **注:** このスイッチは、.NET Framework 4 以降のバージョンでは削除されています。 詳細については、「[セキュリティの変更点](../../../docs/framework/security/security-changes.md)」を参照してください。|  
