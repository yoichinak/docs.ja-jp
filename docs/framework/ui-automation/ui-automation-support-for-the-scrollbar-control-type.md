...
|------------------|------------------|  
|ScrollBar<br /><br /> -Button (2 または 4)<br />-Thumb (0 i:<0)|適用できません。 スクロール バー コントロールは、コンテンツを含みません。|  
...
|コントロール パターン|サポート|メモ|  
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.IScrollProvider>|しない|Scroll コントロール パターンは、スクロール バーで直接的にはサポートされていません。|  
