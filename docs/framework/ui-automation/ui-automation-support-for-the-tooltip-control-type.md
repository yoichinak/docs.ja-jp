...
|------------------|------------------|  
|ヒント<br /><br /> -Text (0 以上)<br />-Image (0 以上)|ヒント|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsControlElementProperty>|正しい|ツール ヒント コントロールは、常にコントロールである必要があります。|  
