...
>  このドキュメントは、[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 名前空間で定義されているマネージド <xref:System.Windows.Automation> クラスを使用する .NET Framework 開発者を対象としています。 に関する最新情報については[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]を参照してください[Windows Automation API:UI オートメーション](https://go.microsoft.com/fwlink/?LinkID=156746)します。  
 ...
 [!INCLUDE[TLA#tla_aa](../../../includes/tlasharptla-aa-md.md)] 以前のアプリケーションにアクセスできるようにソリューションです。 [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)] 新しいユーザー補助モデルは、[!INCLUDE[TLA#tla_win](../../../includes/tlasharptla-win-md.md)]自動テスト ツールおよび支援技術製品のニーズに対応するものです。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 多くの機能強化にはより[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)]します。  
...
## <a name="ui-elements"></a>UI 要素  
 [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] 提示[!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)]要素として、`IAccessible`インターフェイスまたは子識別子として。 2 つの `IAccessible` ポインターを比較してそれらが同じ要素を参照しているかどうかを判断するのは困難です。  
...
## <a name="roles-and-control-types"></a>役割とコントロール型  
 ...
 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] によって識別されますが、カスタム コントロールをサポートしている、<xref:System.Windows.Automation.ControlType.Custom>プロパティによって記述できます、<xref:System.Windows.Automation.AutomationElement.LocalizedControlTypeProperty>プロパティ。  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] ロール|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] コントロールの種類|  
|----------------------------------------------------------------------|----------------------------------------------------------------------------------------|  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] プロパティ アクセサー|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] プロパティ ID|Remarks|  
|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|-------------|  
|`get_accKeyboardShortcut`|<xref:System.Windows.Automation.AutomationElement.AccessKeyProperty> または <xref:System.Windows.Automation.AutomationElement.AcceleratorKeyProperty>|`AccessKeyProperty` 両方が存在する場合が優先されます。|  
...
|`get_accDescription`|サポートされていません [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|`accDescription` 明確な仕様がプロバイダーのこのプロパティでさまざまな情報を配置することで発生したため、MSAA 内にありませんでした。|  
|`get_accHelpTopic`|サポートされていません [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]||  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] state|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] property|状態の変更をトリガーする|  
|-----------------------------------------------------------------------|------------------------------------------------------------------------------------|----------------------------|  
|STATE_SYSTEM_CHECKED|チェック ボックスをオンに <xref:System.Windows.Automation.TogglePattern.ToggleStateProperty><br /><br /> ラジオ ボタン <xref:System.Windows.Automation.SelectionItemPattern.IsSelectedProperty>|Y|  
...
|STATE_SYSTEM_HASPOPUP|<xref:System.Windows.Automation.ExpandCollapsePattern> メニュー項目|N|  
|STATE_SYSTEM_INVISIBLE|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> = True と<xref:System.Windows.Automation.AutomationElement.GetClickablePoint%2A>原因 <xref:System.Windows.Automation.NoClickablePointException>|N|  
...
|STATE_SYSTEM_READONLY|<xref:System.Windows.Automation.RangeValuePattern.IsReadOnlyProperty?displayProperty=nameWithType> と、呼び出し <xref:System.Windows.Automation.ValuePattern.IsReadOnlyProperty?displayProperty=nameWithType>|N|  
|STATE_SYSTEM_SELECTABLE|<xref:System.Windows.Automation.SelectionItemPattern> サポートされています|N|  
...
|-----------------------------------------------------------------------|-------------|  
|STATE_SYSTEM_BUSY|は使用できません。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_DEFAULT|は使用できません。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_ANIMATED|は使用できません。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|STATE_SYSTEM_TRAVERSED|は使用できません。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|STATE_SYSTEM_HOTTRACKED|は使用できません。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_PRESSED|は使用できません。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|WinEvent|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] イベント識別子|  
|--------------|--------------------------------------------------------------------------------------------|  
|EVENT_OBJECT_ACCELERATORCHANGE|<xref:System.Windows.Automation.AutomationElement.AcceleratorKeyProperty> プロパティの変更|  
|EVENT_OBJECT_CONTENTSCROLLED|<xref:System.Windows.Automation.ScrollPattern.VerticalScrollPercentProperty> または<xref:System.Windows.Automation.ScrollPattern.HorizontalScrollPercentProperty>に関連付けられているスクロール バーのプロパティの変更|  
...
|EVENT_OBJECT_HELPCHANGE|<xref:System.Windows.Automation.AutomationElement.HelpTextProperty> 変更|  
...
|同等の機能がありません|<xref:System.Windows.Automation.AutomationElement.AsyncContentLoadedEvent> event|  
