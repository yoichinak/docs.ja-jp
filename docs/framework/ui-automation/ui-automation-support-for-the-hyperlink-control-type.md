...
|---------------------------------------|--------------------|-----------|  
|<xref:System.Windows.Automation.Provider.IInvokeProvider>|○|すべてのハイパーリンク コントロールは、Invoke パターンをサポートする必要があります。|  
