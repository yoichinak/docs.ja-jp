...
|------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|  
|<ul><li>ペイン</li><li>ツリー (スクロール パターン)<br /><br /> <ul><li>TreeItem</li><li>ペイン</li><li>編集 (スクロール パターン)</li></ul></li></ul>|ウィンドウ<br />ツリー (スクロール パターン)<br />-TreeItem<br />-.ウィンドウ<br />編集します。<br />-(スクロール パターン)|  
