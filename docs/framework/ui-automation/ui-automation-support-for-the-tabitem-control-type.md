...
|------------------|------------------|  
|TabItem<br /><br /> <ul><li>イメージ (0 または 1)</li><li>テキスト</li><li>ウィンドウ<br /><br /> <ul><li>各種コントロール (0 以上)</li></ul></li></ul>|TabItem<br /><br /> <ul><li>ウィンドウ<br /><br /> <ul><li>各種コントロール (0 以上)</li></ul></li></ul>|  
