...
|<xref:System.Windows.Automation.Provider.ITransformProvider.Move%2A>|メソッド|None|  
|<xref:System.Windows.Automation.Provider.ITransformProvider.Resize%2A>|メソッド|None|  
|<xref:System.Windows.Automation.Provider.ITransformProvider.Rotate%2A>|メソッド|None|  
