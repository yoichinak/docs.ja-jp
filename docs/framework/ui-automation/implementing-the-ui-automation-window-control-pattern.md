...
|<xref:System.Windows.Automation.WindowInteractionState>|event|保証されません。 <xref:System.Windows.Automation.WindowInteractionState.ReadyForUserInteraction>|  
