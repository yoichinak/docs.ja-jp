...
### <a name="xboolean"></a>x:Boolean  
 ...
 XAML は、 `x:Boolean` の値の大文字と小文字を区別しないで解析します。 `x:Bool` は、承諾済みのプリミティブではありません。 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.17 と 5.4.11](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
  
### <a name="xchar"></a>x:Char  
 CLR バッキングの場合は、 `x:Char` プリミティブは <xref:System.Char>に対応しています。  
  
 文字列型および char 型は、XML レベルでファイルの全体的なエンコーディングと相互作用しています。 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.7 と 5.4.1](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
  
### <a name="xstring"></a>x:String  
 CLR バッキングの場合は、 `x:String` プリミティブは <xref:System.String>に対応しています。  
  
 文字列型および char 型は、XML レベルでファイルの全体的なエンコーディングと相互作用しています。 XAML 言語仕様の定義については、「 [\[\]」セクション 5.2.6](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xdecimal"></a>x:Decimal  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.14 と 5.4.8](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xsingle"></a>x:Single  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.8 と 5.4.2](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xdouble"></a>x:Double  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.9 と 5.4.3](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xint16"></a>x:Int16  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.11 と 5.4.5](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xint32"></a>x:Int32  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.12 および 5.4.6](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xint64"></a>x:Int64  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.13 と 5.4.7](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xtimespan"></a>x:TimeSpan  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.16 と 5.4.10](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xuri"></a>x:Uri  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.15 と 5.4.9](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
  
### <a name="xbyte"></a>x:Byte  
 CLR バッキングの場合は、 `x:Byte` プリミティブは <xref:System.Byte>に対応しています。 `x:Byte`  / <xref:System.Byte>は、unsigned として扱われます。  
  
 XAML 言語仕様の定義については、「 [\[\]」セクション5.2.10 と 5.4.4](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
...
### <a name="xarray"></a>x:Array  
 ...
 XAML 言語仕様の定義については、「 [\[\]」セクション 5.2.18](https://docs.microsoft.com/previous-versions/msp-n-p/ff650760(v=pandp.10))を参照してください。  
