...
|[IEnumRAWINPUTDEVIC:Skip](ienumrawinputdevic-skip.md)|列挙子に対して、次`celt`に[IEnumRAWINPUTDEVIC: next](ienumrawinputdevic-next.md)を呼び出すときにこれらの要素が返されないように、列挙体の次の要素をスキップするように指示します。|  
