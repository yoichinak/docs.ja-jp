...
### <a name="superscripts-and-subscripts"></a>上付き/下付きの文字  
 ...
 ![OpenType の上付き文字を使用してテキストを](./media/opentypefont14.gif "opentypefont14")  
OpenType の上付き文字を使用するテキスト  
 ...
 ![OpenType の下付き文字を使用してテキストを](./media/opentypefont15.gif "opentypefont15")  
...
### <a name="decorative-uses-of-superscripts-and-subscripts"></a>上付き文字と下付き文字の装飾的な用途  
 ...
 ![OpenType の上付き文字と下付き文字を使用してテキストを](./media/opentypefont16.gif "opentypefont16")  
...
## <a name="capitals"></a>大文字  
 ...
 ![OpenType の大文字を使用してテキストを](./media/opentypefont11.gif "opentypefont11")  
...
### <a name="titling-capitals"></a>タイトル用大文字  
 ...
 ![OpenType のタイトル大文字を使用してテキストを](./media/opentypefont20.gif "OpenTypeFont20")  
...
### <a name="capital-spacing"></a>大文字スペーシング  
 ...
 ![OpenType の大文字スペーシングを使用してテキストを](./media/opentypefont21.gif "OpenTypeFont21")  
...
-   **歴史的合字**。 歴史的な記述に相応しい設計で、特に読みやすくなるようには設計されていません。  
 ...
 ![OpenType の標準合字を使用してテキストを](./media/opentypefont04.gif "opentypefont04")  
OpenType の標準合字を使用するテキスト  
 ...
 ![OpenType の随意合字を使用してテキストを](./media/opentypefont05.gif "opentypefont05")  
OpenType の随意合字を使用するテキスト  
 ...
 ![OpenType の標準合字を使用してテキストを](./media/opentypefont06.gif "opentypefont06")  
OpenType の標準合字を使用するテキスト  
  
 ただし、標準合字機能を無効にして、"ff" などの標準合字が、組み合わせ文字グリフとしてではなく、2 つの別々のグリフとして表示されるようにできます。  
  
 ![OpenType の標準合字を無効になっているテキストを使用して](./media/opentypefont07.gif "opentypefont07")  
...
OpenType の標準グリフと飾り付きグリフを使用するテキスト  
 ...
 ![OpenType の巻き髭を使用してテキストを](./media/opentypefont09.gif "opentypefont09")  
...
### <a name="contextual-swashes"></a>コンテキスト飾り付き  
 ...
 ![OpenType のコンテキスト巻き髭を使用してテキストを](./media/opentypefont19.gif "OpenTypeFont19")  
...
## <a name="alternates"></a>代替  
 ...
 ![OpenType の標準グリフを使用してテキストを](./media/opentypefont01.gif "opentypefont01")  
...
OpenType のスタイル代替グリフを使用するテキスト  
 ...
 ![OpenType のスタイル代替グリフを使用してテキストを](./media/opentypefont03.gif "opentypefont03")  
OpenType のスタイル代替グリフを使用するテキスト  
...
### <a name="random-contextual-alternates"></a>ランダムなコンテキスト代替  
 ...
 ![OpenType のランダムなコンテキスト代替を使用してテキストを](./media/opentypefont23.gif "OpenTypeFont23")  
...
### <a name="historical-forms"></a>歴史的形式  
 ...
 ![OpenType の歴史的形式を使用してテキストを](./media/opentypefont10.gif "opentypefont10")  
...
### <a name="fractions"></a>小数  
 ...
 ![スラッシュし、分数を OpenType を使用してテキスト](./media/opentypefont12.gif "opentypefont12")  
...
### <a name="old-style-numerals"></a>旧式スタイルの数字  
 ...
 ![OpenType の旧式スタイルの数字を使用してテキストを](./media/opentypefont24.gif "OpenTypeFont24")  
OpenType の古いスタイルの数字を使用するテキスト  
  
 次のテキストは、Palatino Linotype フォントの標準の数字と、旧式スタイルの数字を示したものです。  
  
 ![OpenType 古いスタイルの数字セットを使用してテキストを](./media/opentypefont13.gif "opentypefont13")  
...
### <a name="proportional-and-tabular-figures"></a>プロポーショナルと表形式の数字  
 ...
 ![OpenType のプロポーショナルと表形式の数字を使用してテキストを](./media/opentypefont22.gif "OpenTypeFont22")  
...
### <a name="slashed-zero"></a>スラッシュ付きゼロ  
 ...
 ![OpenType を使用してテキストをスラッシュ ゼロ](./media/opentypefont17.gif "OpenTypeFont17")  
