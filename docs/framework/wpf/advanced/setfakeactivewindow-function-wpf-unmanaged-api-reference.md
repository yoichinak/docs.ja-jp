---
title: SetFakeActiveWindow 関数 (WPF のアンマネージ API リファレンス)
ms.date: 03/30/2017
dev_langs:
- cpp
api_name:
...
ms.locfileid: "62053406"
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>SetFakeActiveWindow 関数 (WPF のアンマネージ API リファレンス)
