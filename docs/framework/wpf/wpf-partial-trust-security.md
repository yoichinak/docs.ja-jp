...
|----------------|---------------|-------------------|--------------|  
|DNS|DNS サーバーへのアクセス|○|いいえ|  
|環境変数|読み取り|○|いいえ|  
|ファイルダイアログ|Open|○|○|  
|ファイルダイアログ|[無制限]|○|いいえ|  
|分離ストレージ|ユーザーによるアセンブリの分離|○|いいえ|  
|分離ストレージ|不明な分離|○|○|  
|分離ストレージ|無制限のユーザークォータ|○|いいえ|  
|メディア|安全なオーディオ、ビデオ、および画像|○|○|  
|印刷|既定の印刷|○|いいえ|  
|印刷|安全な印刷|○|○|  
|リフレクション|Pdb|○|いいえ|  
|セキュリティ|マネージコードの実行|○|○|  
|セキュリティ|付与されたアクセス許可のアサート|○|いいえ|  
|ユーザー インターフェイス|[無制限]|○|いいえ|  
|ユーザー インターフェイス|セーフトップレベルウィンドウ|○|○|  
|ユーザー インターフェイス|独自のクリップボード|○|○|  
|Web ブラウザー|HTML への安全なフレームナビゲーション|○|○|  
