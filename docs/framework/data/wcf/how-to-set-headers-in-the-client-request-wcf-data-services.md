---
title: '方法: クライアント要求 (WCF Data Services) のヘッダーを設定します。'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "59143261"
---
# <a name="how-to-set-headers-in-the-client-request-wcf-data-services"></a>方法: クライアント要求 (WCF Data Services) のヘッダーを設定します。
