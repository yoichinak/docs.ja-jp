...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 使用する方法について説明します、 [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] .NET Framework クライアント アプリケーションにフィードします。  
  
 [クイック スタート](../../../../docs/framework/data/wcf/quickstart-wcf-data-services.md)  
 作成し、単純なにアクセスする方法を示します[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]-ベースの Northwind サンプル データベースに基づいてフィードを公開するサービス。  
 ...
 リンクを提供します。[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]と[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]リソース。  
