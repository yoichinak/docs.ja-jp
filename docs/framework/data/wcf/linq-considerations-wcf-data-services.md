...
```  
 ...
 LINQ の概要については、次を参照してください。[統合言語クエリ (LINQ) - C# ](../../../csharp/programming-guide/concepts/linq/index.md)または[LINQ (Language-Integrated Query) - Visual Basic](../../../visual-basic/programming-guide/concepts/linq/index.md)します。  
