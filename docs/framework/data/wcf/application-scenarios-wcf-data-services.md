...
- [方法: データ サービスのデータをコントロール (Silverlight クライアント) にバインドします。](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/ee681614(v=vs.103))
...
- [方法: 非同期データ サービス クエリを実行します。](../../../../docs/framework/data/wcf/how-to-execute-asynchronous-data-service-queries-wcf-data-services.md)
...
- [方法: プロジェクトのデータ ソースを使用してデータをバインドします。](../../../../docs/framework/data/wcf/how-to-bind-data-using-a-project-data-source-wcf-data-services.md)

データ サービスへのメッセージを先に取得してクエリのデータ検証およびロール ベースのフィルター処理を実行する。
- [方法: データ サービス メッセージをインターセプトします。](../../../../docs/framework/data/wcf/how-to-intercept-data-service-messages-wcf-data-services.md)
