...
1. [開発 (データベース エンジン)](https://go.microsoft.com/fwlink/?LinkId=115245)  
  
## <a name="in-this-section"></a>このセクションの内容  
 [SQL Server のインスタンスの列挙 (ADO.NET)](../../../../../docs/framework/data/adonet/sql/enumerating-instances-of-sql-server.md)  
 SQL Server のアクティブなインスタンスを列挙する方法について説明します。  
  
 [SQL Server のプロバイダー統計情報](../../../../../docs/framework/data/adonet/sql/provider-statistics-for-sql-server.md)  
 ...
 [SQL Server のデータベース ミラーリング](../../../../../docs/framework/data/adonet/sql/database-mirroring-in-sql-server.md)  
