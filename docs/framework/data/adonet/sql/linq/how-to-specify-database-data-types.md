...
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 属性のプロパティを使用して、t-sqlテーブル宣言内の列を定義するテキストを正確に<xref:System.Data.Linq.Mapping.ColumnAttribute.DbType%2A>指定します。 <xref:System.Data.Linq.Mapping.ColumnAttribute>  
