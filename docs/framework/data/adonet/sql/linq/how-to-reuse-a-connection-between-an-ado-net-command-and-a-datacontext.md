...
は[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] ADO.NET のテクノロジファミリの一部であり、ADO.NET によって提供されるサービスに基づいているため、ADO.NET コマンドとの<xref:System.Data.Linq.DataContext>間の接続を再利用することができます。  
  
## <a name="example"></a>例  
 次の例は、ADO.NET コマンドとの<xref:System.Data.Linq.DataContext>間で同じ接続を再利用する方法を示しています。  
