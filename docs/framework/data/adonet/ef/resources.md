...
次の外部リソースでは、Entity Framework アプリケーションの作成に関する情報とサポートを提供しています。  
 ...
 [Entity Framework デザイン ブログ](https://go.microsoft.com/fwlink/?LinkId=186888)  
 デザインに関する解説と、Entity Framework の将来のバージョンに関する機能の紹介。  
  
 [データ プラットフォーム操作方法 ビデオ:Entity Framework シリーズ](https://go.microsoft.com/fwlink/?LinkId=124600)  
