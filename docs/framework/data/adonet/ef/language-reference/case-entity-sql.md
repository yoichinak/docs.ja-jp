...
## <a name="remarks"></a>Remarks  
 Case [!INCLUDE[esql](../../../../../../includes/esql-md.md)]式は、transact-sql の case 式に似ています。 case 式を使用すると、適切な結果が得られる式を、一連の条件判定によって決めることができます。 この形式の case 式では、1 つまたは複数の `Boolean` 式によって、最終的に使用される式が決定されます。  
