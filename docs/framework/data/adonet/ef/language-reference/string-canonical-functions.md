...
[!INCLUDE[esql](../../../../../../includes/esql-md.md)] 文字列正規関数が含まれています。  
...
|`Contains(string, target)`|`true` が `target` に含まれる場合は、`string` を返します。<br /><br /> **引数**<br /><br /> `string`:検索される文字列。<br /><br /> `target`:検索されるターゲット文字列。<br /><br /> **戻り値**<br /><br /> `true` 場合`target`に含まれている`string`。 そうしないと`false`します。<br /><br /> **例**<br /><br /> `-- The following example returns true.`<br /><br /> `Contains('abc', 'bc')`|  
|`EndsWith(string, target)`|`true` が `target` で終わる場合は、`string` を返します。<br /><br /> **引数**<br /><br /> `string`:検索される文字列。<br /><br /> `target`:対象の文字列の末尾で検索`string`します。<br /><br /> **戻り値**<br /><br /> `True` 場合`string`終わる`target`。 そうしないと`false`します。<br /><br /> **例**<br /><br /> `-- The following example returns true.`<br /><br /> `EndsWith('abc', 'bc')` ***注:** SQL Server のデータ プロバイダーを使用しているかどうか、この関数を返します`false`文字列が固定長文字列の列に格納されているかどうかと`target`は定数です。Iこの場合、末尾の埋め込み空白も含めて文字列全体が検索されます。A回避策は、次の例のように、固定長文字列内のデータをトリムするのには。`EndsWith(TRIM(string), target)`|  
...
|`Left(string, length)`|`length` の左側から最初の `string` 文字を返します。 `string` の長さが `length` よりも短い場合は、文字列全体が返されます。<br /><br /> **引数**<br /><br /> `string`:`String`。<br /><br /> `length`:`Int16`、 `Int32`、 `Int64`、または`Byte`します。 `length` 0 未満はできません。<br /><br /> **戻り値**<br /><br /> `String`。<br /><br /> **例**<br /><br /> `-- The following example returns abc.`<br /><br /> `Left('abcxyz', 3)`|  
...
|`Right(string, length)`|最後に返します`length`文字を`string`します。 `string` の長さが `length` よりも短い場合は、文字列全体が返されます。<br /><br /> **引数**<br /><br /> `string`:`String`。<br /><br /> `length`:`Int16`、 `Int32`、 `Int64`、または`Byte`します。 `length` 0 未満はできません。<br /><br /> **戻り値**<br /><br /> `String`。<br /><br /> **例**<br /><br /> `-- The following example returns xyz.`<br /><br /> `Right('abcxyz', 3)`|  
|`RTrim(string)`|返します`string`末尾の空白文字なし。<br /><br /> **引数**<br /><br /> `String`。<br /><br /> **戻り値**<br /><br /> `String`。|  
|`Substring(string, start, length)`|`start` 位置から長さが `length` 文字の部分文字列を返します。 開始が 1 の場合は、文字列の最初の文字を示します。 インデックスの番号は 1 から始まります。<br /><br /> **引数**<br /><br /> `string`:`String`。<br /><br /> `start`:`Int16`、 `Int32`、`Int64`と`Byte`します。 `start` 1 未満をすることはできません。<br /><br /> `length`:`Int16`、 `Int32`、`Int64`と`Byte`します。 `length` 0 未満はできません。<br /><br /> **戻り値**<br /><br /> `String`。<br /><br /> **例**<br /><br /> `-- The following example returns xyz.`<br /><br /> `Substring('abcxyz', 4, 3)`|  
|`StartsWith(string, target)`|`true` が `string` で始まる場合は、`target` を返します。<br /><br /> **引数**<br /><br /> `string`:検索される文字列。<br /><br /> `target`:対象の文字列の先頭で検索`string`します。<br /><br /> **戻り値**<br /><br /> `True` 場合`string`で始まる`target`。 そうしないと`false`します。<br /><br /> **例**<br /><br /> `-- The following example returns true.`<br /><br /> `StartsWith('abc', 'ab')`|  
