...
## <a name="example"></a>例  
 次の例では、<xref:System.String>入力パラメーターを受け取るクエリをコンパイルして呼び出し、`Contact`指定した文字列で始まる電子メール アドレスを返します。  
...
- [ADO.NETエンティティ フレームワーク](../index.md)
