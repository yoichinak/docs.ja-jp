...
## <a name="in-this-section"></a>このセクションの内容  
 [接続文字列](../../../../../docs/framework/data/adonet/ef/connection-strings.md)  
  
 [Entity Framework データ プロバイダー](../../../../../docs/framework/data/adonet/ef/data-providers.md)  
