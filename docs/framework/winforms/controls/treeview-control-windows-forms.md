...
参照してください[方法。追加し、削除のノードで、Windows フォーム TreeView コントロールのデザイナーを使用して](add-and-remove-nodes-with-wf-treeview-control-using-the-designer.md)、および[方法。デザイナーを使用して TreeNode にショートカット メニューをアタッチ](how-to-attach-a-shortcut-menu-to-a-treenode-using-the-designer.md)します。  
