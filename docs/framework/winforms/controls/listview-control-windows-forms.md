...
## <a name="related-sections"></a>関連項目  
 ...
 イメージ リストの用途、主な機能、およびプロパティについて説明します。  
