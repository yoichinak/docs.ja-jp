---
title: '方法: Windows フォーム コントロールをデザイナーを使用して型にバインドします。'
ms.date: 03/30/2017
helpviewer_keywords:
...
ms.locfileid: "57712098"
---
# <a name="how-to-bind-a-windows-forms-control-to-a-type-using-the-designer"></a>方法: Windows フォーム コントロールをデザイナーを使用して型にバインドします。
