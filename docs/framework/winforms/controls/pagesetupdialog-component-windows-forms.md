---
title: PageSetupDialog コンポーネント (Windows フォーム)
ms.date: 03/30/2017
helpviewer_keywords:
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 インスタンスを使用してページのプロパティを設定する方法について説明します、<xref:System.Windows.Forms.PageSetupDialog>実行時にコンポーネント。  
