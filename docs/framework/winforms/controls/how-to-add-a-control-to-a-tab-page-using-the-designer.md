---
title: '方法: デザイナーを使用してタブ ページにコントロールを追加します。'
ms.date: 03/30/2017
helpviewer_keywords:
- TabPage control
...
ms.locfileid: "57724415"
---
# <a name="how-to-add-a-control-to-a-tab-page-using-the-designer"></a>方法: デザイナーを使用してタブ ページにコントロールを追加します。
