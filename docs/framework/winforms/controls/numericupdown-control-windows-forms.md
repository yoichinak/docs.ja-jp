...
## <a name="related-sections"></a>関連セクション  
 ...
 では、<xref:System.Windows.Forms.NumericUpDown>に似たコントロールが導入されています。ただし、<xref:System.Windows.Forms.DomainUpDown> コントロールには数値ではなく文字列が表示される点が異なります。
