...
1.  保存するファイルのパスを決定します。  
     ...
     実際のアプリケーションでは、通常使用する、<xref:System.Windows.Forms.SaveFileDialog>コンポーネント。 概要については、[SaveFileDialog コンポーネントの概要](savefiledialog-component-overview-windows-forms.md)を参照してください。  
