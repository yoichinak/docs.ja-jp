---
title: BindingNavigator コントロール (Windows フォーム)
ms.date: 03/30/2017
helpviewer_keywords:
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [方法: Windows フォームの BindingNavigator コントロールを使用して DataSet を移動します。](move-through-a-dataset-with-wf-bindingnavigator-control.md)  
 
  `BindingNavigator` コントロールを使用して <xref:System.Data.DataSet> 内のレコードを移動する方法を示します。  
  
 参照してください[方法。保存、読み込みを追加し、[キャンセル] ボタンを Windows フォーム BindingNavigator コントロール](load-save-and-cancel-bindingnavigator.md)します。  
