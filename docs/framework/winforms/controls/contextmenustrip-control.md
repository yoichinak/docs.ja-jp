...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [方法: ContextMenuStrip のチェックの余白とイメージの余白](how-to-configure-contextmenustrip-check-margins-and-image-margins.md)  
 ...
 [方法: ContextMenuStrip のオープン イベントを処理します。](how-to-handle-the-contextmenustrip-opening-event.md)  
 ...
 参照してください[ContextMenuStrip タスク ダイアログ ボックス](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ms233646(v=vs.100))または[ContextMenuStrip Items コレクション エディター](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ms233641(v=vs.100))します。  
