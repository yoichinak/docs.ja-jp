...
2. **[プロパティ]** ウィンドウで、プロパティの横![にある省略記号 (省略記号ボタン ([...])](./media/visual-studio-ellipsis-button.png)をクリックして、 <xref:System.Windows.Forms.TreeView.Nodes%2A>プロパティの横にある [プロパティウィンドウ] ボタンをクリックします。
