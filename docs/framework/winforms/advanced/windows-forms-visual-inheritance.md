...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [方法: [継承ピッカー] ダイアログボックスを使用してフォームを継承する](how-to-inherit-forms-using-the-inheritance-picker-dialog-box.md)  
 ...
 [方法: Modifiers プロパティと GenerateMember プロパティを使用する](how-to-use-the-modifiers-and-generatemember-properties.md)  
