...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 グラフィックス オブジェクトの状態と入れ子になったグラフィックス コンテナーを管理する方法を示します。  
  
 [領域の使用](using-regions.md)  
 ヒット テストとクリッピング領域を示します。  
 ...
 ダブル バッファリングを使用してちらつきを軽減する方法を示します。
