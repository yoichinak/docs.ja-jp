...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 カーディナル スプラインを定義し、それらを描画するために必要なクラスを識別します。  
  
 [GDI+ でのベジエ スプライン](bezier-splines-in-gdi.md)  
 ベジエ スプラインを定義し、それらを描画するために必要なクラスを識別します。  
  
 [GDI+ でのグラフィックス パス](graphics-paths-in-gdi.md)  
 パスを作成し、それらを描画する方法について説明します。  
 ...
 開いた曲線と閉じた曲線を描画し、それらを入力する方法を定義します。  
  
 [GDI+ での領域](regions-in-gdi.md)  
 リージョンに関連付けられたメソッドをについて説明します。  
 ...
 アンチエイリアシングと描画するときにアンチエイリアシングを使用の直線し、曲線を定義します。
