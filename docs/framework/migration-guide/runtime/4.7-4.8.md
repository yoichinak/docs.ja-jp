...
description: .NET Framework 4.7 から 4.8 に移行するときに、ランタイムの変更からのアプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "86443846"
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-48"></a>.NET Framework 4.7 から 4.8 への移行に関するランタイム変更
