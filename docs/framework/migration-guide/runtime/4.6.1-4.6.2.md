---
title: .NET Framework 4.6.1 から 4.6.2 への移行に関するランタイム変更
description: .NET Framework 4.6.1 から 4.6.2 に移行するときに、ランタイムの変更からのアプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "86443989"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a>.NET Framework 4.6.1 から 4.6.2 への移行に関するランタイム変更
