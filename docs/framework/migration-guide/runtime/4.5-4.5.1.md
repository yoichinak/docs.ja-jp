...
description: .NET Framework 4.5 から 4.5.1 に移行するときに、ランタイムの変更からのアプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "86443209"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a>.NET Framework 4.5 から 4.5.1 への移行に関するランタイム変更
