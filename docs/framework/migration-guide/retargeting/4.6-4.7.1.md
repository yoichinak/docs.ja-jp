---
title: .NET Framework 4.6 から 4.7.1 への移行に関する変更の再ターゲット
description: .NET Framework 4.6 から 4.7.1 に移行するときに、アプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "86444197"
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-471"></a>.NET Framework 4.6 から 4.7.1 への移行に関する変更の再ターゲット
