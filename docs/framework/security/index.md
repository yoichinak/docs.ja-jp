...
- [Windows Identity Foundation 4.5 の概要](../../../docs/framework/security/wif-overview.md)

  - [クレームベースの ID モデル](../../../docs/framework/security/claims-based-identity-model.md)

  - [WIF を使用したクレーム ベースの承認](../../../docs/framework/security/claims-based-authorization-using-wif.md)

  - [WIF 要求プログラミング モデル](../../../docs/framework/security/wif-claims-programming-model.md)

- [WIF の概要](../../../docs/framework/security/getting-started-with-wif.md)

  - [クレーム対応の ASP.NET Web アプリケーションを初めて構築する](../../../docs/framework/security/building-my-first-claims-aware-aspnet-web-app.md)

  - [クレーム対応の WCF サービスを初めて構築する](../../../docs/framework/security/building-my-first-claims-aware-wcf-service.md)
...
- [WIF コード サンプル インデックス](../../../docs/framework/security/wif-code-sample-index.md)

- [WIF の拡張](../../../docs/framework/security/wif-extensions.md)
...
- [WIF 構成のリファレンス](../../../docs/framework/security/wif-configuration-reference.md)
  ...
  - [WIF 構成スキーマの規則](../../../docs/framework/security/wif-configuration-schema-conventions.md)
