...
6. 次に示すように、 **C:** ドライブのルートにある名前付き**ログ**に新しいフォルダーを作成します。**C:\logs**
