...
以下にこの動作を示す使用例をいくつか示します (ターゲットが 2.0 の場合):

- 2.0 が指定されます。 インストールされているパッチ バージョンのうち、一番上が 2.0.5 です。 2.0.5 が使用されます。
- 2.0 が指定されます。 2\.0.* バージョンはインストールされていません。 インストールされているランタイムのうち、一番上が 1.1.1 です。 エラー メッセージが表示されます。
- 2.0 が指定されます。 2\.0.* バージョンはインストールされていません。 インストールされている 2.x ランタイム バージョンのうち、一番上が 2.2.2 です。 2.2.2 が使用されます。
- 2.0 が指定されます。 2\.x バージョンはインストールされていません。 3.0.0 がインストールされます。 エラー メッセージが表示されます。

マイナー バージョン ロールフォワードには、エンド ユーザーに影響を与える可能性がある副作用が 1 つあります。 次のシナリオについて検討してください。

1. アプリケーションで 2.0 が必要であると指定されます。
2. 実行すると、バージョン 2.0.* はインストールされませんが、2.2.2 がインストールされます。 バージョン 2.2.2 が使用されます。
3. 後で、ユーザーが 2.0.5 をインストールし、もう一度アプリケーションを実行すると、2.0.5 が使用されるようになりました。
