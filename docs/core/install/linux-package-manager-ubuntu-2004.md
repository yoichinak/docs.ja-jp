...
---
# <a name="ubuntu-2004-package-manager---install-net-core"></a>Ubuntu 20.04 パッケージ マネージャー - .NET Core のインストール

[!INCLUDE [package-manager-switcher](./includes/package-manager-switcher.md)]

この記事では、パッケージ マネージャーを使用して Ubuntu 20.04 に .NET Core をインストールする方法について説明します。
