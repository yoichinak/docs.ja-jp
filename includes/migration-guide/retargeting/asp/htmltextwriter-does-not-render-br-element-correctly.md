...
|   |   |
|---|---|
|説明|.NET Framework 4.6 以降では、<code>&lt;BR /&gt;</code> 要素を指定して <xref:System.Web.UI.HtmlTextWriter.RenderBeginTag(System.String)> と <xref:System.Web.UI.HtmlTextWriter.RenderEndTag> を呼び出すと、<code>&lt;BR /&gt;</code> が 1 つのみ (2 つではなく) 正しく挿入されます。|
