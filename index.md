                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>.NET Framework API リファレンス</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/desktop-wpf/">デスクトップ ガイド (WPF)</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Core チュートリアル</h3>
                                                    <p>ASP.NET Core アプリケーションを開発する方法を学習できる、さまざまなステップ バイ ステップ ガイドがあります。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio での ASP.NET Core</h3>
                                                    <p>Visual Studio を使用した、ASP.NET Core MVC Web アプリの構築の基礎について説明します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>.NET 用 Azure のドキュメント</h3>
                                                    <p>Web Apps、WebJobs、Cloud Services、および VM などの Azure サービスについて説明します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure ストレージ</h3>
                                                    <p>Azure Storage と、Azure BLOB、テーブル、キュー、ファイルを使用したアプリケーションの作成方法を説明します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure での F# の使用</h3>
                                                    <p>Azure Storage、Cloud Services、Azure Functions などの F# を使用するさまざまな Azure サービスについて説明します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin.iOS</h3>
                                                    <p>Xamarin.iOS で C# と F# を使用してネイティブ iOS アプリを作成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Xamarin.Android で C# と F# を使用してネイティブ Android アプリを作成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin.Forms</h3>
                                                    <p>Xamarin.Forms で C# と F# を使用してクロスプラットフォームのモバイル UI を作成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ユニバーサル Windows アプリ</h3>
                                                    <p>すべての Windows 10 デバイスで実行されるユニバーサル Windows アプリを作成する方法を説明します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>WPF では、開発者が Windows でデスクトップ アプリケーションを構築するための XAML ベースのモデルが用意されています。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows フォーム</h3>
                                                    <p>Windows デスクトップ用の基幹業務アプリを迅速に開発できます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>macOS 向けの Xamarin</h3>
                                                    <p>Xamarin で C# と F# を使用して macOS 向けのアプリを作成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio を使用したゲーム開発</h3>
                                                    <p>Visual Studio で任意のゲーム エンジンを使用して、ゲームを作成してデバッグします。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CRYENGINE</h3>
                                                    <p>CRYENGINE を使用して C# でゲームを構築する方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>MonoGame ライブラリ ドキュメント ハブで、チュートリアルとセットアップ インストラクションを通して、C# を使用してゲームを構築します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>.NET マイクロサービス:コンテナー化された .NET アプリケーションのアーキテクチャ</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft プラットフォームとツールでコンテナー化された Docker アプリケーションのライフサイクル</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure クラウドと Windows コンテナーで既存の .NET アプリケーションを最新式にする</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Core および Azure での最新の Web アプリケーションの設計</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サーバーレス アプリ: アーキテクチャ、パターン、および Azure の実装</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>プレビュー</strong> Azure 向けクラウド ネイティブ .NET アプリケーションの設計</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>プレビュー</strong> ASP.NET Web Forms 開発者向け Blazor</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>プレビュー</strong> WCF 開発者向け ASP.NET Core gRPC</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
